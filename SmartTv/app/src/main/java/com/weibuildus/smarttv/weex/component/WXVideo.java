...
public class WXVideo extends WXComponent implements SysVideoPlayer.OnSysVideoPlayerEventListener {
    ...
    public void seekTo(double seekTo) {
        ...
        wxVideoView.seekTo((int) (wxVideoView.getDuration() * seekTo));
    }

    /**
     * 不放状态 play 播放  pause 暂停 none 置空不会有任何操作
     * @param state
     */
    ...
    public void fullScreen(String screen) {
    ...
    public void onSysVideoProgressUpdate(int duration, int currentposition) {
        ...
        WXSDKManager.getInstance().fireEvent(mInstanceId, getRef(), "progressupdate", params);
    }
}