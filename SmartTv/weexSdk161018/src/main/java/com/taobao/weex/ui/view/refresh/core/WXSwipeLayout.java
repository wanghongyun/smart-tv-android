...
public class WXSwipeLayout extends FrameLayout implements NestedScrollingParent {
  ...
  private static final float overFlow = 0.6f;
  ...
  public void setRefreshHeight(int height) {
    refreshViewHeight = height * 0.125f;
    refreshViewFlowHeight = height * overFlow;
  }

  public void setLoadingHeight(int height) {
    loadingViewHeight = height * 0.125f;
    loadingViewFlowHeight = height * overFlow;
  }
