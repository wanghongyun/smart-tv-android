...
public class MultiImageSelectorActivity extends FragmentActivity implements MultiImageSelectorFragment.Callback{
    ...
    protected void onStart() {
        super.onStart();
        //状态颜色,优先采用浅色背景深色字体，如若不能，则采用深色背景浅色字体
        Integer systemBarDarkColor = 0xFF000000;
        Integer systemBarLightColor = 0xFFFFFFFF;
        StatusBarUtil.StatusBarDarkLightColorLogic(this, systemBarDarkColor, systemBarLightColor);
    }
